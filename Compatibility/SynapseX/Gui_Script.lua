...
function Drag(i, j)
	...
	game:service("UserInputService").InputChanged:Connect(function(p)
		if p == l and k then
			o(p)
		end
	end)
...
function a:Window(w)
	...
	y.Name = "Top"
	y.Parent = t;
	y.BackgroundColor3 = Color3.fromRGB(27, 27, 27)
	y.BorderSizePixel = 0;
	...
	A.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0.00, Color3.fromRGB(26, 75, 255)),
		ColorSequenceKeypoint.new(0.20, Color3.fromRGB(26, 75, 255)),
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(26, 75, 255)),
		ColorSequenceKeypoint.new(0.80, Color3.fromRGB(26, 75, 255)),
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(26, 75, 255))
	}
	...
	local function I()
		...
		x = not x;
		local H = true;
		b.TweenService:Create(E, TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
			Size = UDim2.new(0, 212, 0, x and F.AbsoluteContentSize.Y + 4 or 0)
		}):Play()
		b.TweenService:Create(D, TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
	...
	function K:Button(L, N)
		...
		P.MouseEnter:Connect(function()
			b.TweenService:Create(O, TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
	...
	function K:Toggle(Q, R, S, N, T)
		...
		V.MouseEnter:Connect(function()
			b.TweenService:Create(U, TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
				BackgroundColor3 = Color3.fromRGB(55, 55, 55)
			}):Play()
		end)
		...
		V.MouseButton1Click:Connect(function()
			T[R] = not T[R]
			spawn(function()
				b.TweenService:Create(W, TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
	...
	function K:Slider(Y, Z, _, a0, N, S, T)
		...
		a5.Font = Enum.Font.GothamSemibold;
		...
		a8.Name = "SliderPart"
		a8.Parent = a6;
		a8.BackgroundColor3 = Color3.fromRGB(20, 94, 255)
		...
		a5.InputBegan:Connect(function(p)
			if p.UserInputType == Enum.UserInputType.MouseButton1 then
				spawn(function()
					b.TweenService:Create(a8, TweenInfo.new(0.15), {
		...
		a5.InputEnded:Connect(function(p)
			if p.UserInputType == Enum.UserInputType.MouseButton1 then
				spawn(function()
					b.TweenService:Create(a8, TweenInfo.new(0.15), {
						BackgroundColor3 = Color3.fromRGB(24, 105, 255)
					}):Play()
				end)
				k = false
			end
